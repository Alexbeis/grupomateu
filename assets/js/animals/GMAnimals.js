...
(function(window, $, swal) {
    ...
    window.GMAnimals = function($wrapper) {
    ...
    $.extend(window.GMAnimals.prototype, {
...
let AnimalTableWrapper = $('#animal-table');
//let ModalWrapper = $('#modal-add-explotation');

if (AnimalTableWrapper.length > 0) {
    let GM = new GMAnimals(AnimalTableWrapper);
}